...
log_event "Making scripts executable"
if [ ! -f "/home/vdiuser/PVE-VDIClient/vdiclient.py" ]; then
  log_event "vdiclient.py not found in /home/vdiuser/PVE-VDIClient. Exiting script."
  dialog --title "Error" --msgbox "vdiclient.py not found. Ensure the repository was cloned correctly." 10 50
  exit 1
fi
chmod +x /home/vdiuser/PVE-VDIClient/vdiclient.py
